...
function MeetYourName({ onNext }) {
  ...
  return (
    <div style={{ textAlign: "center", padding: "20px 16px" }}>
      <div style={{
        fontSize: 28, fontWeight: 800, color: "#6C5CE7", marginBottom: 6,
        fontFamily: "'Fredoka One', cursive",
        textShadow: "2px 2px 0 #A29BFE"
      }}>
        Hi Caroline! 👋
      </div>
        ...
        {LETTERS.map((letter, i) => (
          ...
          >
            <div style={{
              ...
              color: tapped[i] ? "#fff" : COLORS[i],
              fontFamily: "'Fredoka One', cursive",
              lineHeight: 1,
            }}>{letter}</div>
            {tapped[i] && (
              <div style={{ fontSize: 18 }}>{EMOJIS[i]}</div>
            )}
          </button>
        ))}
      </div>
      ...
      <div style={{
        ...
        gap: 8, marginBottom: 28, maxWidth: 600, margin: "0 auto 28px"
      }}>
        {LETTERS.map((letter, i) => (
          tapped[i] && (
            <div key={i} style={{
      ...
      <button
        ...
        style={{
          ...
          border: "none", borderRadius: 24, padding: "14px 30px",
          color: "#fff", fontSize: 18, fontWeight: 800,
          boxShadow: "0 6px 20px #A29BFE66",
          cursor: "pointer", marginBottom: 16, display: "block", margin: "0 auto 14px",
          fontFamily: "'Fredoka One', cursive"
        }}
      >
        🔊 Say My Whole Name!
      ...
      {allTapped && (
        <button
          ...
          style={{
            ...
            border: "none", borderRadius: 24, padding: "14px 36px",
            color: "#fff", fontSize: 20, fontWeight: 800,
            boxShadow: "0 6px 20px #FF6B9D66",
...
function LetterHunt({ onNext }) {
  ...
  return (
    <div style={{ textAlign: "center", padding: "20px 16px" }}>
      <div style={{
        fontSize: 26, fontWeight: 800, color: "#FF6B9D",
        fontFamily: "'Fredoka One', cursive", marginBottom: 6,
        textShadow: "2px 2px 0 #FD79A8"
      }}>
        🔍 Letter Hunt!
      </div>
      ...
      {!done ? (
        <>
          <div style={{ fontSize: 16, color: "#666", marginBottom: 16, fontWeight: 600 }}>
            Find the letter...
          </div>
          <div style={{
            fontSize: 80, fontWeight: 900,
            color: COLORS[TARGET.indexOf(nextTarget)],
            fontFamily: "'Fredoka One', cursive",
            lineHeight: 1, marginBottom: 16,
            filter: "drop-shadow(3px 3px 0 " + COLORS[TARGET.indexOf(nextTarget)] + "66)",
            animation: "pulse 1.2s ease-in-out infinite"
          }}>
            {nextTarget}
          </div>
        ...
        <div style={{
          fontSize: 26, color: "#1DD1A1", fontWeight: 800,
      ...
      <div style={{
        ...
        {TARGET.map((l, i) => (
          <div key={i} style={{
            ...
            background: collected.includes(l) ? COLORS[i] : "#f0f0f0",
            border: `3px solid ${collected.includes(l) ? COLORS[i] : "#ddd"}`,
            display: "flex", alignItems: "center", justifyContent: "center",
            fontSize: 22, fontWeight: 900,
            color: collected.includes(l) ? "#fff" : "#ccc",
            fontFamily: "'Fredoka One', cursive",
            transition: "all 0.4s cubic-bezier(0.34,1.56,0.64,1)",
            transform: collected.includes(l) ? "scale(1.1)" : "scale(1)"
          }}>
      ...
      <div style={{
        ...
        {grid.map((letter, idx) => {
          ...
          return (
            <button
              key={idx}
              onClick={() => !isFound && !done && tap(letter, idx)}
              style={{
                height: 66, borderRadius: 18,
                background: isFound ? COLORS[letterIdx] : "#fff",
                border: `3px solid ${isFound ? COLORS[letterIdx] : "#e0e0e0"}`,
                boxShadow: isFound
                  ? `0 4px 14px ${COLORS[letterIdx]}55`
                  : "0 2px 8px rgba(0,0,0,0.08)",
                fontSize: 28, fontWeight: 900,
                color: isFound ? "#fff" : "#444",
                fontFamily: "'Fredoka One', cursive",
                cursor: isFound ? "default" : "pointer",
                transform: shaking === idx ? "translateX(-5px)" : "scale(1)",
                animation: shaking === idx ? "shake 0.4s ease" : "none",
      ...
      {done && (
        <button
          ...
          style={{
            ...
            border: "none", borderRadius: 24, padding: "14px 36px",
            color: "#fff", fontSize: 20, fontWeight: 800,
            boxShadow: "0 6px 20px #1DD1A166",
            cursor: "pointer", fontFamily: "'Fredoka One', cursive",
            animation: "pulse 1.2s ease-in-out infinite"
          }}
        >
          Now let's WRITE it! ✏️ →
        </button>
      )}
    </div>
  );
...
function WriteYourName({ onFinish }) {
  ...
  return (
    <div style={{ textAlign: "center", padding: "20px 16px" }}>
      <div style={{
        fontSize: 26, fontWeight: 800, color: "#FF9F43",
        fontFamily: "'Fredoka One', cursive", marginBottom: 4,
        textShadow: "2px 2px 0 #FECA5766"
      }}>
        ✏️ Write Your Name!
      </div>
      <div style={{ fontSize: 14, color: "#888", fontWeight: 600, marginBottom: 16 }}>
        Use your finger to trace or write <span style={{ color: "#FF6B9D", fontWeight: 800 }}>Caroline</span>!
      </div>
      ...
      <div style={{ display: "flex", gap: 10, justifyContent: "center", flexWrap: "wrap" }}>
        <button
          onClick={() => setShowGuide(g => {
            ...
            ctx.fillStyle = "#FFFEF7";
            ctx.fillRect(0, 0, canvas.width, canvas.height);
            if (next) drawGuide(ctx);
            return next;
          })}
          style={{
            background: showGuide ? "#A29BFE" : "#f0f0f0",
        ...
        <button
          onClick={clear}
          style={{
            background: "#FFE0EC", border: "none", borderRadius: 18,
            padding: "10px 20px", color: "#FF6B9D",
            fontSize: 15, fontWeight: 700, cursor: "pointer",
            fontFamily: "'Fredoka One', cursive"
          }}
        >
        ...
        {hasDrawn && (
          <button
            ...
            style={{
              ...
              border: "none", borderRadius: 18, padding: "10px 24px",
              color: "#fff", fontSize: 15, fontWeight: 800, cursor: "pointer",
              fontFamily: "'Fredoka One', cursive",
              boxShadow: "0 4px 16px #FF6B9D55",
              animation: "pulse 1.2s ease-in-out infinite"
            }}
          >
            🌟 I Did It!
...
function Celebration({ onRestart }) {
  ...
  useEffect(() => {
    const utt = new SpeechSynthesisUtterance(
      "Hooray! You are so amazing Caroline! You can recognize and write your name!"
    );
    utt.rate = 0.85;
    utt.pitch = 1.3;
    window.speechSynthesis.speak(utt);
  ...
  return (
    <div style={{ textAlign: "center", padding: "40px 24px" }}>
      ...
      <div style={{
        ...
        fontFamily: "'Fredoka One', cursive",
        background: "linear-gradient(135deg, #FF6B9D, #FF9F43, #FECA57, #48DBFB, #6C5CE7)",
      ...
      <div style={{
        fontSize: 22, fontWeight: 800, color: "#6C5CE7",
        fontFamily: "'Fredoka One', cursive", marginBottom: 8
      }}>
      ...
      <div style={{
        ...
        {LETTERS.map((l, i) => (
          <div key={i} style={{
            ...
            borderRadius: 20,
            background: COLORS[i],
            boxShadow: `0 6px 20px ${COLORS[i]}66`,
            display: "flex", flexDirection: "column",
            alignItems: "center", justifyContent: "center",
            animation: `popIn 0.4s ${i * 0.1}s cubic-bezier(0.34,1.56,0.64,1) both`,
          }}>
            <div style={{
      ...
      <div style={{ fontSize: 20, color: "#888", fontWeight: 700, marginBottom: 28 }}>
        C - A - R - O - L - I - N - E 🌟
      </div>
...
// ── MAIN APP ──────────────────────────────────────────────────────────────────
const SCREENS = ["meet", "hunt", "write", "celebrate"];
const SCREEN_LABELS = ["Meet Your Name", "Letter Hunt", "Write It!", "🌟"];
...
export default function CarolineApp() {
  ...
  return (
    <>
      ...
      <div style={{
        minHeight: "100vh",
        background: "linear-gradient(160deg, #fff9ff 0%, #f0f4ff 50%, #fff8ee 100%)",
        ...
        <div style={{
          ...
          <div style={{
            fontSize: 13, color: "rgba(255,255,255,0.9)", fontWeight: 700,
          ...
          {SCREEN_LABELS.map((label, i) => (
            <button
              ...
              style={{
                ...
                color: screen === i ? "#fff" : i < screen ? COLORS[i * 2] : "#bbb",
                cursor: i <= screen ? "pointer" : "default",
                transition: "all 0.3s",
                fontFamily: "'Fredoka One', cursive",
                boxShadow: screen === i ? `0 3px 10px ${COLORS[i * 2]}55` : "none"
              }}
            >
              {i < screen ? "✓ " : ""}{label}
            </button>
        ...
        <div style={{ maxWidth: 640, margin: "0 auto" }}>
          ...
          {screen === 2 && <WriteYourName onFinish={() => goTo(3)} />}
          {screen === 3 && <Celebration onRestart={() => goTo(0)} />}
        </div>
